...
un_overflow_coefficient = 100000
...
def calculate_mass_distribution(bigrams_dict, number_of_words=number_of_words_global):
    mass_vector = [word_mass(bigrams_dict[word], number_of_words) for word in
                   bigrams_dict]
...
#    weight = (un_overflow_coefficient*word_dict[counter_key]) / global_words_counter
#    print(weight)
#    return weight
